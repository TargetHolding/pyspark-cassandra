...
public abstract class StructPickler implements IObjectPickler {
	...
	public void pickle(Object o, OutputStream out, Pickler pickler) throws PickleException, IOException {
		...
		pickler.save(this.getFieldNames(o));
		pickler.save(this.getFieldValues(o));
		out.write(Opcodes.TUPLE);
		out.write(Opcodes.REDUCE);
	}

	public abstract Object getFieldNames(Object o);

	public abstract Object getFieldValues(Object o);
