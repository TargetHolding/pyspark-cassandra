...
Currently PySpark Cassandra has been succesfully used with Spark version 1.2.0, 1.2.1 and 1.2.2 and DataStax Spark Cassandra Connector version 1.2. Feedback on (in-)compatibility with other versions is much appreciated.
